...
#include "TreeSpawnerNew.generated.h"

UCLASS()
class SPLINEIMPORTER_API ATreeSpawnerNew : public AActor
{
    GENERATED_BODY()
...
public:
    ...
    UFUNCTION(BlueprintCallable, Category = "TreeSpawnerNew")
    void ProcessOSMUserData();

    UFUNCTION(CallInEditor, Category = "TreeSpawnerNew")
    void ProcessOSMUserDataFromEditor();

    UPROPERTY(BlueprintReadOnly, Category = "TreeSpawnerNew")
    ...
    UPROPERTY(BlueprintReadWrite, Category = "TreeSpawnerNew")
